...
namespace Tutorion
{
    public class Startup
    {
        ...
        public static readonly SymmetricSecurityKey SecurityKey =
            new SymmetricSecurityKey(Encoding.Default.GetBytes("this would be a real secret"));
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddEntityFrameworkNpgsql().AddDbContext<TutorionApiContext>(opt =>
                opt.UseNpgsql(Configuration.GetConnectionString("TutorionApiConnection")));
